...
import { Link, useNavigate } from "react-router-dom"; //페이지 이동을 위한 useNavigate 훅 사용
...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <h1 className="text-6xl font-bold mb-20 max-w-1/2 flex">Weatherpeek</h1>
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="flex flex-col gap-6 w-full max-w-xl px-6"
      >
        {/* 아이디 입력 */}
        <input
          type="text"
